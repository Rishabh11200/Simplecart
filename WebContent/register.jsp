...
<div class="form-group">
  <label class="col-md-4 control-label">Address</label>  
    ...
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
  		<textarea rows="5" cols="20" class="form-control" name="add" placeholder = "Address" required></textarea>
  </div>
  </div>
</div>
...
<div class="container">Already registered?<a href="login.jsp">Login here!</a></div>
</fieldset>
</form>
</div>
    </div>
